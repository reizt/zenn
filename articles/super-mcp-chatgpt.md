...
また、先述のデメリットを考慮し現在はトレーニング履歴や食事履歴といった読み取りさえできれば良いデータに関してはSpreadsheetへの同期システムを構築してChatGPTにそれを読ませる構成に変更しています。Super MCPはその自由度の高さを生かして、書き込みを伴うAPIを集約する場所として活用していく方針です。
